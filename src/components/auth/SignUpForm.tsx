...
export default function SignUpForm() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      await signUp({ email, password, firstName: fname || undefined, lastName: lname || undefined });
        ...
        <div>
          ...
          <div>
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              <button type="button" onClick={() => social("google")} className="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
              ...
              <button type="button" onClick={() => social("microsoft")} className="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div className="sm:col-span-1">
                    ...
                    <Input type="text" id="fname" name="fname" placeholder="Enter your first name" value={fname} onChange={(e) => setFname(e.target.value)} />
                  </div>
                  <div className="sm:col-span-1">
                    <Label>Last Name<span className="text-error-500">*</span></Label>
                    <Input type="text" id="lname" name="lname" placeholder="Enter your last name" value={lname} onChange={(e) => setLname(e.target.value)} />
                  </div>
                </div>
                <div>
